#' 
#' to1check is a collection of functions for working with the TBESC2
...
#' For example, #' gen_consent_checklist() produces a .csv file with a record
...
#' @docType package
#' @name to1check
#' @aliases to1check to1check-package
NULL
